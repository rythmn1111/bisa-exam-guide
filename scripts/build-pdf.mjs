...
const OUT = path.resolve(argOf("--out", path.join(ROOT, "BISA-Exam-Guide.pdf")));
...
try {
  ...
  const header = `<div style="width:100%;font-family:-apple-system,system-ui,sans-serif;font-size:7pt;color:#8a8a94;padding:0 15mm;display:flex;justify-content:space-between;"><span>Introduction to Python — The Exam Guide</span><span>Goa Institute of Management · BIFS 2026–27</span></div>`;
